...
public class Reflections {
    ...
    public static Object invokeGetter(Object obj, String propertyName) {
        try {
            Method readMethod = getAccessibleMethodByFieldName(obj.getClass(), propertyName);
    ...
    public static void invokeSetter(Object obj, String propertyName, Object value) {
        try {
            ...
            Object realValue = ConvertUtils.convertIfNecessary(value, propertyDescriptor.getPropertyType());
            writeMethod.invoke(obj,  new Object[] {realValue});
        } catch (Exception e) {
            throw convertReflectionExceptionToUnchecked(e);
        }
    }
    ...
    public static void setFieldValue(final Object obj, final String fieldName, final Object value) {
        ...
        try {
            Object realValue = ConvertUtils.convertIfNecessary(value, field.getType());
     ...
     *
     */
    public static Method getAccessibleMethodByFieldName(final Class<?> clazz, final String fieldName) {
        Validate.notNull(clazz, "clazz can't be null");
        Validate.notBlank(fieldName, "fieldName can't be blank");
    ...
    /**
     * 根据field名字，通过反射其getter方法，获取其数据库字段名字
     */
    public static String getColumnNameByFieldName(final Class<?> clazz, final String fieldName){
        Validate.notNull(clazz, "clazz can't be null");
        Validate.notBlank(fieldName, "fieldName can't be blank");

        Method method = Reflections.getAccessibleMethodByFieldName(clazz, fieldName);
    ...
    public static <T> Class<T> findParameterizedType(Class<?> clazz, int i) {
    ...
    /**
     * 将map里面的数据，复制到obj对应的字段
     */
    public static void extractToObject(Object obj, Map<String, Object> map){

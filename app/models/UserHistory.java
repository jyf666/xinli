...
public class UserHistory implements java.io.Serializable {
	...
	/** minimal constructor */
	public UserHistory(Integer uid, String account, String password,
			String name, String sex, Date birthday, String useStatus,
			Date lastLogintime, Date userDateCreated,
			Date dateCreated) {
		this.uid = uid;
	...
	public UserHistory(Integer uid, String account, String password,
			...
			String phone, String email, String useStatus,
			Date lastLogintime, String photo, String idCard,
			Date userDateCreated, Date dateCreated) {
		this.uid = uid;
		this.account = account;
		this.password = password;
		this.name = name;
	...
	@Temporal(TemporalType.TIMESTAMP)
	@Column(name = "user_date_created", nullable = false, length = 19)
